...
- 使用在 64 位的 Windows 10 系统上运行的 [PyInstaller v5.7.0](https://github.com/pyinstaller/pyinstaller/releases/tag/v5.7.0) 打包。

- 使用了 [2.1.3.dev8 版本的 pygame 第三方库](https://github.com/pygame/pygame/releases/tag/2.1.3.dev8)。

- .zip 格式版本包含了 [v4.134.3 版本的 LXGW Bright GB 字体](https://github.com/lxgw/LxgwBright/releases/tag/v4.134.3)。
